...
public class OperationServiceImpl {
    ...
    public Page<EmployeeHasProject> getEmployeeProjects(int employeeId, int page){
    ...
    public Page<EmployeeProjectHasTask> getEmployeeProjectsTask(int employeeId,int projectId, int page){
